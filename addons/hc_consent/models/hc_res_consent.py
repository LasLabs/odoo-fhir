...
class Consent(models.Model):    
    ...
    consentor_ids = fields.One2many(
        comodel_name="hc.consent.consentor", 
    ...
    organization_id = fields.Many2one(
        ...
        string="Organization", 
        help="Organization that manages the consent.")               
...
class ConsentExceptData(models.Model):    
    ...
    reference_consent_id = fields.Many2one(
        ...
        help="Consent the actual data reference.")                
...
class ConsentConsentor(models.Model):   
    ...
    consent_id = fields.Many2one(
        comodel_name="hc.res.consent", 
        string="Consent", 
        help="Consent associated with this Consent Consentor.")               
    consentor_type = fields.Selection(
        string="Consentor Type", 
        required="True", 
        selection=[
            ("Organization", "Organization"), 
            ("Patient", "Patient"), 
    ...
    value_name = fields.Char(
        ...
        store="True", 
        help="Who is agreeing to the policy and exceptions.")             
    consentor_organization_id = fields.Many2one(
        comodel_name="hc.res.organization", 
        string="Consentor Organization", 
        help="Organization who is agreeing to the policy and exceptions.")             
    consentor_patient_id = fields.Many2one(
        comodel_name="hc.res.patient", 
        string="Consentor Patient", 
        help="Patient who is agreeing to the policy and exceptions.")             
    consentor_practitioner_id = fields.Many2one(
        comodel_name="hc.res.practitioner", 
        string="Consentor Practitioner", 
        help="Practitioner who is agreeing to the policy and exceptions.")             
    consentor_related_person_id = fields.Many2one(
        comodel_name="hc.res.related.person", 
        string="Consentor Related Person", 
...
class ConsentRecipient(models.Model):   
    ...
    consent_id = fields.Many2one(
        comodel_name="hc.res.consent", 
        string="Consent", 
        help="Consent associated with this Consent Recipient.")               
