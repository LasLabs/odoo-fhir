...
class DiagnosticRequest(models.Model):    
    ...
    subject_name = fields.Char(string="Subject", compute="compute_subject_name", help="Who and/or what test is about.")                    
    ...
    context_type = fields.Selection(string="Context Type", selection=[("Encounter", "Encounter"), ("Episode Of Care", "Episode of Care")], help="Encounter or Episode during which request was created.")                    
    context_name = fields.Char(string="Context", compute="compute_context_name", help="Encounter or Episode during which request was created.")
    ...
    occurence_type = fields.Selection(string="Occurence Type", selection=[("datetime", "Datetime"), ("period", "Period"), ("timing", "Timing")], help="Type of when testing should occur.")                    
    occurrence_name = fields.Char(string="Occurrence", compute="compute_occurrence_name", help="When testing should occur.")             
    ...
    requester_type = fields.Selection(string="Requester Type", selection=[("device", "Device"), ("practitioner", "Practitioner"), ("organization", "Organization")], help="Type of who/what is requesting diagnostics.")                    
    requester_name = fields.Char(string="Requester", compute="compute_requester_name", help="Who/what is requesting diagnostics.")                    
    requester_device_id = fields.Many2one(comodel_name="hc.res.device", string="Requester Device", help="Device who/what is requesting diagnostics.")
    ...
    requested_type = fields.Selection(string="Requested Type", selection=[("Practitioner", "Practitioner"), ("Organization", "Organization"), ("Patient", "Patient"), ("Device", "Device"), ("RelatedPerson", "Relatedperson")], help="Type of requested perfomer.")
    requested_name = fields.Char(string="Requested", compute="compute_requested_name", help="Requested perfomer.")
    requested_practitioner_id = fields.Many2one(comodel_name="hc.res.practitioner", string="Requested Practitioner", help="Practitioner requested perfomer.")
    requested_organization_id = fields.Many2one(comodel_name="hc.res.organization", string="Requested Organization", help="Organization requested perfomer.")
    requested_patient_id = fields.Many2one(comodel_name="hc.res.patient", string="Requested Patient", help="Patient requested perfomer.")
    requested_device_id = fields.Many2one(comodel_name="hc.res.device", string="Requested Device", help="Device requested perfomer.")
    requested_related_person_id = fields.Many2one(comodel_name="hc.res.related.person", string="Requested Related Person", help="Related Person requested perfomer.")
...
class DiagnosticRequestBasedOn(models.Model):    
    ...
    based_on_type = fields.Selection(string="Based On Type", selection=[("string", "String"), ("code", "Code")], help="Type of what request fulfills.")                    
    based_on_name = fields.Char(string="Based On", compute="compute_based_on_name", help="What request fulfills.")                    
...
class DiagnosticRequestDefinition(models.Model):    
    ...
    definition_type = fields.Selection(string="Definition Type", selection=[("string", "String"), ("Diagnostic Request", "Diagnostic Request")], help="Type of protocol or definition.")                    
    definition_name = fields.Char(string="Definition", compute="compute_definition_name", help="Protocol or definition.")                    
...
class DiagnosticRequestReplaces(models.Model):    
    ...
    replaces_type = fields.Selection(string="Replaces Type", selection=[("string", "String"), ("Diagnostic Request", "Diagnostic Request")], help="Type of what request replaces.")                    
    replaces_name = fields.Char(string="Replaces", compute="compute_replaces_name", help="What request replaces.")                    
...
class DiagnosticRequestSupportingInfo(models.Model):    
    ...
    supporting_info_type = fields.Selection(string="Supporting Info Type", selection=[("string", "String"), ("Diagnostic Request", "Diagnostic Request")], help="Type of additional clinical information.")                    
    supporting_info_name = fields.Char(string="Supporting Info", compute="compute_supporting_info_name", help="Additional clinical information.")                    
