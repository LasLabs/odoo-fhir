...
class Group(models.Model):    
    ...
    characteristic_ids = fields.One2many(comodel_name="hc.group.characteristic", inverse_name="group_id", string="Characteristics", help="Trait of group members.")                
    member_ids = fields.One2many(comodel_name="hc.group.member", inverse_name="group_id", string="Members", help="Who or what is in group.")                
