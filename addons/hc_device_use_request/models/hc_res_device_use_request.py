...
class DeviceUseRequest(models.Model):    
    ...
    stage_id = fields.Many2one(
        comodel_name="hc.vs.request.stage", 
        string="Device Use Request Stage", 
        required="True", 
    ...
    device_id = fields.Many2one(
        ...
        string="Device", 
        help="Device requested.")                
    device_code_id = fields.Many2one(
        comodel_name="hc.vs.device.kind", 
        string="Device Code", 
        help="Code of device requested.")                
...
class DeviceUseRequestIdentifier(models.Model):    
    ...
    device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Device Use Request", 
        help="Device Use Request associated with this Device Use Request Identifier.")                
...
class DeviceUseRequestDefinition(models.Model):    
    ...
    device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Device Use Request", 
        help="Device Use Request associated with this Device Use Request Definition.")                
    ...
    definition_device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Definition Device Use Request", 
        help="Device Use Request protocol or definition.")                
...
class DeviceUseRequestBasedOn(models.Model):    
    ...
    device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Device Use Request", 
        help="Device Use Request associated with this Device Use Request Based On.")                
    ...
    based_on_device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Based On Device Use Request", 
        help="Device Use Request what request fulfills.")                
...
class DeviceUseRequestReplaces(models.Model):    
    ...
    device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Device Use Request", 
        help="Device Use Request associated with this Device Use Request Replaces.")                
    ...
    replaces_device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Replaces Device Use Request", 
        help="Device Use Request what request replaces.")                   
...
class DeviceUseRequestReasonReference(models.Model):    
    ...
    device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Device Use Request", 
        help="Device Use Request associated with this Device Use Request Reason Reference.")                
    reason_refererence_type = fields.Selection(
        string="Reason Refererence Type", 
        selection=[
            ("string", "String"), 
            ("Device Use Request", "Device Use Request")], 
        help="Type of linked reason for request.")                
    reason_refererence_name = fields.Char(
        string="Reason Refererence", 
        compute="_compute_reason_refererence_name", 
        store="True", 
        help="Linked Reason for request.")                
    reason_reference_string = fields.Char(
        string="Reason Reference String", 
        help="String of linked reason for request.")                
    reason_reference_device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Reason Reference Device Use Request", 
        help="Device Use Request linked reason for request.")                
...
class DeviceUseRequestSupportingInfo(models.Model):    
    ...
    device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Device Use Request", 
        help="Device Use Request associated with this Device Use Request Supporting Info.")                
    ...
    supporting_info_device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Supporting Info Device Use Request", 
        help="Device Use Request additional clinical information.")                
...
class DeviceUseRequestNote(models.Model):    
    ...
    device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Device Use Request", 
        help="Device Use Request associated with this Device Use Request Note.")                
...
class DeviceUseRequestRelevantHistory(models.Model):    
    ...
    device_use_request_id = fields.Many2one(
        comodel_name="hc.res.device.use.request", 
        string="Device Use Request", 
        help="Device Use Request associated with this Device Use Request Relevant History.")                
