...
class ProvenanceAgent(models.Model):    
    ...
    actor_name = fields.Char(string="Actor", compute="_compute_actor_name", store="True", help="Part of this action.")                
    actor_practitioner_id = fields.Many2one(comodel_name="hc.res.practitioner", string="Actor Practitioner", help="Practitioner part of this action.")                
    actor_related_person_id = fields.Many2one(comodel_name="hc.res.related.person", string="Actor Related Person", help="Related Person part of this action.")                
    actor_patient_id = fields.Many2one(comodel_name="hc.res.patient", string="Actor Patient", help="Patient part of this action.")                
    actor_device_id = fields.Many2one(comodel_name="hc.res.device", string="Actor Device", help="Device part of this action.")                
    actor_organization_id = fields.Many2one(comodel_name="hc.res.organization", string="Actor Organization", help="Organization part of this action.")                
